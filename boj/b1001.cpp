...
#ifndef ONLINE_JUDGE
//freopen("/Users/liwenjie/CLionProjects/test1/boj/poj1001/input.txt","r",stdin);//如果不是在OJ上运行那么就从本地的这个文件中读取信息;
#endif
using namespace std;
...
public:
    ...
    void print();       //输出大数
    void to_str(string &string_temp);
};
...
void BigNum::to_str(string &string_temp) {
    stringstream stream;
    string cstr;
    stream << a[len - 1];
